...
[AddComponentMenu("SimplePath/FootprintComponent")]
public class FootprintComponent : MonoBehaviour 
{
    ...
    private int             m_numObstructedCells;
	...
	void Awake()
	{
        ...
        m_numObstructedCells = 0;
	}

    public int[] GetCachedObstructedCells(Grid grid, out int numObstructedCells)
    {
        if (null == m_obstructedCellPool)
            return this.GetObstructedCells(grid, out numObstructedCells);
        else
        {
            numObstructedCells = m_numObstructedCells;
	...
	public int[] GetObstructedCells(Grid grid, out int numObstructedCells)
	{
        ...
        m_numObstructedCells = numObstructedCells;
