...
[ExecuteInEditMode]
public class Token : MonoBehaviour, System.IComparable<Token>
{
    #region Public enums
    ...
    public Token[] links = { null, null, null, null };
    #endregion
    
    public int CompareTo(Token other)
    {
        return this.lengthOrRadius.CompareTo(other.lengthOrRadius);
    }
    ...
    public void OnMove()
    {
        ...
        if (isCenterPivot)
            matWorld *= SBSMatrix4x4.TRS(-Vector3.forward * lengthOrRadius * 0.5f, Quaternion.identity, SBSVector3.one);
...
//          Gizmos.DrawRay(p0, t0);
    ...
    void OnDrawGizmos()
    {
        ...
        this.DrawGizmos(-1.0f, Color.red);
        this.DrawGizmos(1.0f, Color.red);
    }
