...
[AddComponentMenu("SimplePath/SteeringAgentComponent")]
public class SteeringAgentComponent : MonoBehaviour 
{
	#region Unity Editor Fields
    public Vector3                                  m_wantedVelocity = Vector3.zero;
	...
	void OnDrawGizmos()
	{
		...
		{
            Gizmos.DrawRay(transform.position, m_wantedVelocity);//rigidbody.velocity);
		}
	}
	#endregion
