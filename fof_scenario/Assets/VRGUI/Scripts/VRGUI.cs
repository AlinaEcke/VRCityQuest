...
{
	public Vector3 guiPosition      = new Vector3(0f, 0f, 1.0f);
	public float   guiSize          = 0.5f;
	...
	private void Initialize () 
	{
		...
		if (useCurvedSurface)
		{
            ...
            backgroundPlane = Instantiate(Resources.Load("VRGUICurvedSurface")) as GameObject; 
		}
		else
		{
        ...
        backgroundPlane.transform.parent = this.transform;
        backgroundPlane.transform.localPosition = guiPosition + new Vector3(0.0f, 0.0f, 1.0f);
        backgroundPlane.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
        backgroundPlane.transform.localScale = new Vector3(guiSize * 5.0f, guiSize * 5.0f, guiSize);
