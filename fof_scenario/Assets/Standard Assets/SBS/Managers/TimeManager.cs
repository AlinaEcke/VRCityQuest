...
//#if !UNITY_EDITOR
    ...
    {
        if (Application.runInBackground || Application.platform == RuntimePlatform.OSXWebPlayer)
            return;
...
//#endif
    ...
    public void OnGamePaused()
    {
        ...
        GameObject managers = GameObject.FindGameObjectWithTag("GameManagers");
        managers.BroadcastMessage("OnPause", SendMessageOptions.DontRequireReceiver);
    }
    ...
    public void OnGameResumed()
    {
        ...
        GameObject managers = GameObject.FindGameObjectWithTag("GameManagers");
        managers.BroadcastMessage("OnResume", SendMessageOptions.DontRequireReceiver);
    }
    #endregion
}
